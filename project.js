...
function changeColor() {
    ...
    document.getElementById('btn2').style.backgroundColor = "#FF7D7D";
    document.getElementById('btn3').style.backgroundColor = "#FF7D7D";
    document.getElementById('btn4').style.backgroundColor = "#FF7D7D";
}
